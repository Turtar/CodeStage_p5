export class Stage {
    ...
    createMiniMap(p, stageParams, sliderValues) {
        ...
        this._drawMiniOneSide(p, this.miniMap, stageParams.top, sliderValues.top, true);
        this._drawMiniOneSide(p, this.miniMap, stageParams.bottom, sliderValues.bottom, false);
    }
